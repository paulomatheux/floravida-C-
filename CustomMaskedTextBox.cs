...
namespace CustomControls.RJControls
{
    ...
    public partial class CustomMaskedTextBox : UserControl
    {
        ...
        private string mask;
        private bool promptChar = false;
        private MaskFormat format;
        private char ptpChar;
        private int selectlength;

        //Constructor
        public CustomMaskedTextBox() {
            InitializeComponent();
            this.textBox1.CutCopyMaskFormat = MaskFormat.ExcludePromptAndLiterals;
        }
        ...
        public char PtpChar {
            ...
            {
                ptpChar = value;
                this.textBox1.PromptChar = value;
            }
		}
		...
		public int Selectlength
        {
            ...
            set
            {
                selectlength = this.textBox1.SelectionLength;
            }   
        }
		...
		protected override void OnPaint(PaintEventArgs e) {
            ...
            if (borderRadius > 1) {
                ...
                using (Pen penBorder = new Pen(borderColor, borderSize))
				{
                    ...
                    if(borderRadius > 15) SetTextBouxRoundedRegion();
		...
		private void SetTextBouxRoundedRegion()	{
